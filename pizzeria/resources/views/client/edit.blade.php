        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form id="editClientForm" method="POST" action="{{ route('clients.update', $client->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address" name="address" placeholder="Direccion" value="{{ $client->address }}">
                        </div>

                        <div class="mb-3">
                            <label for="phone" class="form-label">Numero de telefono</label>
                            <input type="number" class="form-control" id="phone" name="phone" placeholder="Numero de telefono" value="{{ $client->phone }}">
                        </div>
    ...
    $(document).ready(function() {
        $('#editClientForm').on('submit', function(event) {
            ...
            Swal.fire({
                ...
                $('#editClientForm').unbind('submit').submit();
            });
        });
    });
</script>