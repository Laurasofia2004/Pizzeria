        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form id="editPizza_SizeForm" method="POST" action="{{ route('pizza_sizes.update', $pizza_size->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="name" name="name">
                                ...
                                <option value="{{ $pizza->id }}"
                                    {{ $pizza_size->pizza_id == $pizza->id ? 'selected' : '' }}>
                                    {{ $pizza->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" placeholder="Numero de telefono" value="{{ $pizza_size->price }}">
                        </div>
...
<script>
    $(document).ready(function() {
        $('#editPizza_SizeForm').on('submit', function(event) {
            ...
            Swal.fire({
                ...
                $('#editPizza_SizeForm').unbind('submit').submit();
            });
        });
    });
</script>