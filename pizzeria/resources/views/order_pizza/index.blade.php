                        ...
                        <tbody>
                            ...
                            <tr>		
                                ...
                                <td>
                                    ...
                                    <form id="order_pizzasDelete" action="{{ route('order_pizzas.destroy', $order_pizza->id) }}" method="POST" style="display: inline-block">
                                        @csrf @method('DELETE')
...
<script>
    $(document).ready(function() {
        $('#order_pizzasDelete').on('submit', function(e) {
