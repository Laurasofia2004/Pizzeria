            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form id="EmpleadoForm" method="POST" action="{{ route('employees.store') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="identification_number" name="identification_number" placeholder="Numero de identificacion">
                            </div>

                            <div class="mb-3">
                                <label for="salary" class="form-label">Salario</label>
                                <input type="number" class="form-control" id="salary" name="salary" placeholder="Salario">
                            </div>

                            <div class="mb-3">
                                <label for="hire_date" class="form-label">Inicio de Contrato</label>
                                <input type="date" class="form-control" id="hire_date" name="hire_date" placeholder="Inicio de Contrato">
                            </div>
        ...
        $(document).ready(function() {
            $('#EmpleadoForm').on('submit', function(event) {
                ...
                Swal.fire({
                    ...
                    $('#EmpleadoForm').unbind('submit').submit();
                });
            });
        });
    </script>