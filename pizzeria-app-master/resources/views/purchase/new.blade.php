                ...
                <div class="p-6 text-gray-900">
                    <form id="purchaseForm" method="POST" action="{{ route('purchases.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="purchase_price" name="purchase_price" placeholder="Precio">
                        </div>

                        <div class="mb-3">
                            <label for="purchase_date" class="form-label">Fecha</label>
                            <input type="date" class="form-control" id="purchase_date" name="purchase_date" placeholder="Fecha">
                        </div>
